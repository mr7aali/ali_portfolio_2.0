          ...
          <div className="2xl:w-4/5 max-w-7xl mx-auto w-11/12">
            <div className="grid grid-cols-3">
              ...
              >
                <a
                  href="/#about"
                  className="uppercase no-underline  text-sm after:absolute after:bg-gradient-to-r after:bottom-0 after:from-transparent after:h-px after:inset-x-0 after:scale-x-0 after:to-transparent after:transition-transform after:via-neutrals-200 focus-visible:after:-scale-x-100 hover:after:-scale-x-100 p-1 relative text-neutrals-50"
                >
                  About
                </a>
                <a
                  href="/#work"
                  className="uppercase no-underline  text-sm after:absolute after:bg-gradient-to-r after:bottom-0 after:from-transparent after:h-px after:inset-x-0 after:scale-x-0 after:to-transparent after:transition-transform after:divide-zinc-200 "
                >
                  Work
                </a>
