  ...
  return (
    <div className="max-w-[1040px] mx-auto sm:mt-10 ">
      <div className="flex flex-col-reverse sm:flex-row">
        <motion.div className="px-5 sm:px-3">
          <h1 className="text-[30px] lg:text-[50px] font-extrabold font-sans">
            {/* Discover my Amazing Art Space!... */}
            Hello, I am
            <p
              style={{ fontWeight: "bold" }}
              className="text-[40px] lg:text-[57px] font-thin"
            >
              <Typewriter
                words={[
                  "Web Developer",
          ...
          <p className="pt-5 text-[16px] lg:text-xl font-serif text-justify sm:text-left">
            ...
            <span className="inline sm:hidden">
              On this website, you&apos;ll find a collection of my web
              development projects, from e-commerce solutions to interactive web
              applications.
            </span>
            I&apos;m excited to share my work with you, so feel free to explore
            my portfolio, and don&apos;t hesitate to reach out for potential
            collaborations or projects. Let&apos;s create something amazing
            together!
          </p>
        ...
        <motion.div className="flex items-center justify-center p-3 lg:p-10">
